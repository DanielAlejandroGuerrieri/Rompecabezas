...
var instrucciones = ['Presiona las teclas en la direccion en la que desea mover la pieza', 'La imagen a completar es la imagen objetivo'];
...
function chequearSiGano() {
    ...
    for (var fila = 0; fila < grilla.length; fila++) {
        for (var colum = 0; colum < grilla.length; colum++) {
            if (grilla[fila][colum] !== grillaGanadora[fila][colum]) {
                return false;
            }
        }
    }
...
function mostrarCartelGanador() {
    //COMPLETAR
    alert('Felicitaciones!! Es el ganador.');
    var ingreso = parseInt(prompt('Ingrese las opciones: \n1- Iniciar nuevo juego.\n2- Salir del juego.'));
    switch (ingreso) {
        case 1:
            mezclarPiezas(35);
            break;
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    ...
    console.log('valor de temporal: ' + temporal + 'valor filapos1: ' + filaPos1 + 'filapos2: ' + filaPos2 + '\ncolumnapos1: ' + columnaPos1 + ' columnapos2: ' + columnaPos2);
...
/*
function ultimosCincoMovimientos() {
    var ultimosCincoMovimientos = 0;
    for (var i = 0; 5 < movimientos.length; i++) {

        ultimosCincoMovimientos += movimientos[]; // ver para hacer!!!
    }
}
*/
...
function iniciar() {
    ...
    mezclarPiezas(30);
    capturarTeclas();
    var botonMezclar = document.getElementById('mezclarPiezas');
